...
/**
 * @ingroup tmlCallback
 * @brief command ready handler interface
 */
public interface TmlJniCmdReadyIF{
  
  /**
   * @brief command ready handler method
   *
  ...
  /**
   * @brief command ready handler method name
   */
  public static final String CB_NAME = "jniCmdReadyCB";
}
