 ...
 */
public interface TMLSndStreamWriteHandlerIF{
  /**
   * @brief stream write handler method
   *
   * @see TMLSndStream#registerWriteHandler(TMLSndStreamWriteHandlerIF, Object)
   ...
   */
  int sndStreamWrite(long strID, byte[] buffer, int count, Object cbData);
}
