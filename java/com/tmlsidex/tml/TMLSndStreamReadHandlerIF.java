 ...
 * @brief stream read handler interface
 */
public interface TMLSndStreamReadHandlerIF{
  /**
   * @brief stream read handler method
   *
   * @see TMLSndStream#registerReadHandler(TMLSndStreamReadHandlerIF, Object)
   ...
   */
  int sndStreamRead(long strID, Object cbData, byte[] buffer, int count);
}
