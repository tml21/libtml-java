 ...
 */
public interface TMLEvtPeerRegisterHandlerIF{
  /**
   * @brief event subscription / unsubscription request handler method
   *
   * @see TMLProfile#registerEvtPeerHandler(TMLEvtPeerRegisterHandlerIF, Object)
   ...
   */
  boolean evtPeerRegistrationCB(boolean bSubscribe, String sIP, String sPort, Object cbData);
}
